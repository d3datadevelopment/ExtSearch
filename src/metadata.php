...
$aModule = array(
    ...
    'extend'      => array(
        OxidController\Admin\ArticleList::class             => \D3\Extsearch\Modules\Application\Controller\Admin\d3_article_list_extsearch::class,
        OxidController\ArticleDetailsController::class      => \D3\Extsearch\Modules\Application\Controller\d3_details_extsearch::class,
        OxidCore\Model\BaseModel::class                     => \D3\Extsearch\Modules\Application\Model\d3_basemodel_extsearch::class,
        OxidModel\Article::class                            => \D3\Extsearch\Modules\Application\Model\d3_oxarticle_phonetic::class,
        OxidModel\ArticleList::class                        => \D3\Extsearch\Modules\Application\Model\d3_oxarticlelist_extsearch::class,
        OxidComponent\BasketComponent::class                => \D3\Extsearch\Modules\Application\Component\d3_oxcmp_basket_extsearch::class,
        OxidComponent\UtilsComponent::class                 => \D3\Extsearch\Modules\Application\Component\d3_oxcmp_utils_extsearch::class,
        OxidComponent\Widget\ArticleDetails::class          => \D3\Extsearch\Modules\Application\Component\d3_oxwarticledetails_extsearch::class,
        OxidComponent\Widget\ArticleBox::class              => \D3\Extsearch\Modules\Application\Component\d3_oxwarticlebox_extsearch::class,
        OxidComponent\Locator::class                        => \D3\Extsearch\Modules\Application\Controller\d3_oxlocator_extsearch::class,
        OxidController\ArticleListController::class         => \D3\Extsearch\Modules\Application\Controller\d3_alist_extsearch::class,
        OxidController\ManufacturerListController::class    => \D3\Extsearch\Modules\Application\Controller\d3_manufacturerlist_extsearch::class,
        OxidController\VendorListController::class          => \D3\Extsearch\Modules\Application\Controller\d3_vendorlist_extsearch::class,
        OxidController\RssController::class                 => \D3\Extsearch\Modules\Application\Controller\d3_rss_extsearch::class,
        OxidModel\RssFeed::class                            => \D3\Extsearch\Modules\Application\Model\d3_oxrssfeed_extsearch::class,
