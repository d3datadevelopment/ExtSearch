...
$aModule = array(
    'd3FileRegister'    => array(
        ...
        'd3/extsearch/Application/Model/d3_querygenerator.php',
        ...
        'd3/extsearch/tests/integration/assignedFilters/priceArrayFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/vendorMultiFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/manufacturerSingleFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/priceSliderFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/manufacturerMultiFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/vendorSingleFilterInjectionTest.php',
        ...
        'd3/extsearch/tests/integration/assignedFilters/categoryMultiFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/categoryMultiFilterVariantsTest.php',
        'd3/extsearch/tests/integration/assignedFilters/categorySingleFilterTest.php',
        'd3/extsearch/tests/integration/assignedFilters/categorySingleFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/categorySingleFilterVariantsTest.php',
        ...
        'd3/extsearch/tests/integration/assignedFilters/attributeSingleFilterInjectionTest.php',
        'd3/extsearch/tests/integration/assignedFilters/attributeMultiFilterTest.php',
        'd3/extsearch/tests/integration/assignedFilters/attributeMultiFilterInjectionTest.php',
        ...
        'd3/extsearch/tests/unit/Application/Model/d3_querygeneratorTest.php',
        'd3/extsearch/tests/unit/Application/Model/Filters/d3ManufacturerFilterTest.php',
        'd3/extsearch/tests/unit/Modules/Application/Model/d3_oxarticlelist_extsearchTest.php',
