...
//Navigation
    ...
    'D3_EXTSEARCH_MAIN_VARIANTUSAGE_DESC'             => 'Here you can set whether, in the case of a found variant, this variant itself or its parent article should be shown in the hit list. When displaying the parent article instead of the variant, please note that the parent article must also be active and selectable. An additional check on this only takes place if it has been explicitly configured.',
    'D3_EXTSEARCH_MAIN_VARIANTINALIST_DESC'           => 'If category, vendor and manufacturer pages are also to use these variant settings, activate this option. This changes the basic list generation when you use article variants.',
