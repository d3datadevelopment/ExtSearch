            ...
            <td style="vertical-align: top; text-align: left; width: 50%" class="edittext">
                ...
                <table style="padding: 0; border: 0">
                    [{block name="d3_admin_attribute_extsearch_form"}]
                        ...
                        <tr>
                            <td class="edittext">
                                <label for="d3hideoneitemfilter">[{oxmultilang ident="D3_EXTSEARCH_ATTRIBUTE_HIDEONEITEMFILTER"}]</label>
                            </td>
                            <td class="edittext">
                                <input type="hidden" name="editval[oxattribute__d3hideoneitemfilter]" value="0">
                                <input type="checkbox" name="editval[oxattribute__d3hideoneitemfilter]" id="d3hideoneitemfilter" value="1" class="edittext" [{if $edit->oxattribute__d3hideoneitemfilter->value == 1}]CHECKED[{/if}] [{$readonly}]>
                                [{oxinputhelp ident="D3_EXTSEARCH_ATTRIBUTE_HIDEONEITEMFILTER_DESC"}]
                            </td>
                        </tr>
