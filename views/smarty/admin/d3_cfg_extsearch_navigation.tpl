                            ...
                            [{block name="d3_cfg_extsearch_navigation__catfilter"}]
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        <input id="showCatList" class="edittext ext_edittext" type="checkbox" name="value[blExtSearch_showCatList]" value='1' [{if $edit->getEditValue('blExtSearch_showCatList') == 1}]checked[{/if}] onclick='[{include file="@d3_extsearch/admin/d3_togglegroup_extsearch.tpl" sToggleOptionName="blExtSearch_showCatList" sToggleOptionClass=".category_options"}]' [{$readonly}]>
