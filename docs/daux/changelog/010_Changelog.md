...
## [Unreleased](https://git.d3data.de/D3Private/Extsearch/compare/7.1.7.1...rel_7.x)

## [7.1.7.1](https://git.d3data.de/D3Private/Extsearch/compare/7.1.7.0...7.1.7.1) - 2025-11-10
### Fixed
- uneindeutiges Feld in Abfrage genauer spezifiziert
- zusammengeführte Synonymgruppen optimiert (Performance)
